...
SELECT * FROM OUR_FIRST_DB.public.time_travel_clone before (statement => '01c3c93f-0001-a9f1-000d-d87a001406b6');

CREATE OR REPLACE TABLE OUR_FIRST_DB.PUBLIC.time_travel_clone_of_clone
CLONE OUR_FIRST_DB.public.time_travel_clone before (statement => '01c3c93f-0001-a9f1-000d-d87a001406b6');
