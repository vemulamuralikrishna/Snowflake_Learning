...
SELECT * FROM OUR_FIRST_DB.public.test before (statement => '01c38019-0001-9f9e-000d-d87a000d1206');
...
CREATE OR REPLACE TABLE OUR_FIRST_DB.public.test as
SELECT * FROM OUR_FIRST_DB.public.test before (statement => '01c38019-0001-9f9e-000d-d87a000d11f6');
