...
SELECT * FROM OUR_FIRST_DB.public.test before (timestamp => '2026-03-30 16:52:48.030 +0000'::timestamp);
...
SELECT * FROM OUR_FIRST_DB.public.test before (statement => '01c360b6-0001-9832-000d-d87a000af6da');
